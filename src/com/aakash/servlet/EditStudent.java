...
protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	out.print("<tr><td>Gender:</td><td><input type='text' name='sex' value='"+st.getGender()+"'/></td></tr>");
	out.print("<tr><td>Course:</td><td><input type='text' name='course' value='"+st.getCourse()+"'/></td></tr>");
	out.print("<tr><td>Fee:</td><td><input type='text' name='fee' value='"+st.getFee()+"'/></td></tr>");
	out.print("<tr><td>Paid:</td><td><input type='text' name='paid'  value='"+st.getPaid()+"'/></td></tr>");
	out.print("<tr><td>Due:</td><td><input type='text' name='due'  value='"+st.getDue()+"'/></td></tr>");
	out.print("<tr><td>Address:</td><td><textarea name='address' style='width:300px;height:100px;'>"+st.getAddress()+"</textarea></td></tr>");
	out.print("<tr><td>Contact No:</td><td><input type='text' name='contact' value='"+st.getContact()+"'/></td></tr>");
