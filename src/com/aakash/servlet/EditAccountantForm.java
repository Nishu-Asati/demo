...
import com.aakash.beans.Accountant;
...
protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	out.println("<body>");
		...
		out.println("<tr><td>Name:</td><td><input type='text' name='name' value='"+acc.getName()+"'></td></tr>");
		out.println("<tr><td>Email:</td><td><input type='email' name='email' value='"+acc.getEmail()+"'></td></tr>");
		out.println("<tr><td>Password:</td><td><input type='password' name='password' value='"+acc.getPassword()+"'></td></tr>");
		out.println("<tr><td>Address:</td><td><textarea name='address' style='width:300px;height:300px;'>"+acc.getAddress()+"</textarea></td></tr>");
		out.println("<tr><td>Contact:</td><td><input type='text' name='contact' value='"+acc.getContact()+"'></td></tr>");
